...
class Metaclass_HdStatus(type):
    """Metaclass of message 'HdStatus'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'my_interfaces.msg.HdStatus')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__hd_status
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__hd_status
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__hd_status
            cls._TYPE_SUPPORT = module.type_support_msg__msg__hd_status
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__hd_status
...
class HdStatus(metaclass=Metaclass_HdStatus):
    """Message class 'HdStatus'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.debug = kwargs.get('debug', str())
    ...
    def debug(self, value):
        if self._check_fields:
            assert \
                ...
                "The 'debug' field must be of type 'str'"
        self._debug = value
