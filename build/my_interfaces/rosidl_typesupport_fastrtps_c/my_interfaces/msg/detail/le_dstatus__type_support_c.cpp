...
#include "my_interfaces/msg/detail/le_dstatus__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/primitives_sequence.h"  // ledx_status
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // ledx_status

// forward declare type support functions


using _LEDstatus__ros_msg_type = my_interfaces__msg__LEDstatus;
...
{
  // Field name: ledx_status
  {
    size_t size = ros_message->ledx_status.size;
    auto array_ptr = ros_message->ledx_status.data;
  ...
  my_interfaces__msg__LEDstatus * ros_message)
{
  // Field name: ledx_status
  {
    ...
    if (!rosidl_runtime_c__int64__Sequence__init(&ros_message->ledx_status, size)) {
      fprintf(stderr, "failed to create array for field 'ledx_status'");
      return false;
    }
    auto array_ptr = ros_message->ledx_status.data;
  ...
  size_t current_alignment)
{
  ...
  // Field name: ledx_status
  {
    size_t array_size = ros_message->ledx_status.size;
    auto array_ptr = ros_message->ledx_status.data;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces__msg__LEDstatus;
    is_plain =
      (
      offsetof(DataType, ledx_status) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const my_interfaces__msg__LEDstatus * ros_message = static_cast<const my_interfaces__msg__LEDstatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_my_interfaces__msg__LEDstatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  my_interfaces__msg__LEDstatus * ros_message = static_cast<my_interfaces__msg__LEDstatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_my_interfaces__msg__LEDstatus(cdr, ros_message);
}

static uint32_t _LEDstatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_interfaces__msg__LEDstatus(
...
static size_t _LEDstatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_interfaces__msg__LEDstatus(
