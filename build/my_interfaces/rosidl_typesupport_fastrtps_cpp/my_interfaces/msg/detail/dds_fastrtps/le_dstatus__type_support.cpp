...
#include "my_interfaces/msg/detail/le_dstatus__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_interfaces::msg::LEDstatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: ledx_status
  {
    cdr << ros_message.ledx_status;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_interfaces::msg::LEDstatus & ros_message)
{
  // Member: ledx_status
  {
    cdr >> ros_message.ledx_status;
  ...
  size_t current_alignment)
{
  ...
  // Member: ledx_status
  {
    ...
    size_t item_size = sizeof(ros_message.ledx_status[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_interfaces::msg::LEDstatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_interfaces
max_serialized_size_key_LEDstatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const my_interfaces::msg::LEDstatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_interfaces::msg::LEDstatus *>(
    untyped_ros_message);
...
{
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_LEDstatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_interfaces, msg, LEDstatus)() {
  return &my_interfaces::msg::typesupport_fastrtps_cpp::_LEDstatus__handle;
}
